...
<template>
  <div class="svg-container">
    <svg class="overlap-svg" width="120" height="36">
      ...
      <!-- <line x1="15" y1="0" x2="15" y2="18" stroke="blue" stroke-width="1" /> -->
      <!-- <line x1="15" y1="18" x2="15" y2="36" stroke="yellow" stroke-width="1" /> -->
      <!-- <line x1="15" y1="18" x2="30" y2="36" stroke="red" stroke-width="1" /> -->
      ...
      <line
        v-else-if="props.relation.is_exist_next_feature"
        x1="15"
        y1="0"
        x2="15"
        y2="36"
      ...
      <line
        v-else-if="props.relation.is_exist_next_story"
        x1="45"
        y1="0"
        x2="45"
        y2="36"
      ...
      <!-- task:state -->
      <foreignObject x="96" y="3.5" width="30" height="30" opacity="0.8">
