    ...
    >
      ...
      >
        <div xmlns="http://www.w3.org/1999/xhtml" v-if="props.item.state == ItemState.IDLE">
          <v-icon :color="is_hovered ? COLOR_MOUSE_OVER : tree.t.color" size="16">
            mdi-circle-outline
          </v-icon>
        </div>
      ...
      >
        <div xmlns="http://www.w3.org/1999/xhtml">
          <v-icon :color="is_hovered ? COLOR_MOUSE_OVER : tree.t.color" size="20"
