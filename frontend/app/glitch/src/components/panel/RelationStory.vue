...
<template>
  <div class="svg-container">
    <svg class="overlap-svg" width="100" height="36">
      ...
      <!-- background:state -->
      <foreignObject x="48" y="3.5" width="30" height="30" opacity="1.0">
